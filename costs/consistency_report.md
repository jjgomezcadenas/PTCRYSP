...
- PASS: 6 CSV tables, Excel sheets/named tables and generated slides.
- PASS: all 112 input/derived values match Excel cached values; formulas match Python expressions.
